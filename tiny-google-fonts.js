var tinyGoogleFontsScript = document.querySelector('script[src*="tiny-google-fonts"]'),
    usedCharacters = usedCharacters = document.body.innerText.replace(/(.)(?=.*\1)/g, ""),
    googleFontClass = tinyGoogleFontsScript.getAttribute('data-font-class'), // Should be optional
    ...
    googleFontsLink = '<link rel="stylesheet" href="//fonts.googleapis.com/css?family=' + googleFontFamily + googleFontWeight + googleFontStyle + '&text=' + usedCharacters + '%20">';
